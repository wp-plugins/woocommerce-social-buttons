...
function va_wc_sh_li_reg_like_settings() {
    register_setting('va_wc_share_like', 'licence_key');
...
function va_wc_sh_social_facebook_init() {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['Submit'])) {
        ...
        update_option('licence_key', $licence_key);
                ...
                <form name="social" method="post">   
                    ...
                    <table class="form-table admintbl">
                        ...
                        <h3 class="form_table_tr_th">
                            <?php _e(" Activation/Licence Key Settings:", 'woocommerce-social-buttons'); ?></h3></th></tr>
                        <?php if (get_option('licence_key') == '' || get_option('status_key') != 'verified') { ?>

                            <tr valign="top">
                                <th scope="row"><?php _e("Generate key:", 'woocommerce-social-buttons'); ?>&nbsp; &nbsp;&nbsp;<a href="http://vivacityinfotech.net/generate-licence-key/" target="_blank">Click Here</a></th>
                            </tr>
                        <?php } ?>
                    </table>
                    <table class="form-table admintbl">
